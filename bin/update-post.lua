...
local slug = arg[2]
if ( session_filename == nil or slug == nil ) then
    error("command line args 'session-filename' and 'slug' are missing. usage: " .. arg[0] .. " session-filename slug")
end 
...
local request_body = { 
                         ...
                         submit_type   = "Update",
                         original_slug = slug,
                         markup        = "# Test Update Post " .. dt .. "\n\nHello World from a Lua Script\n\nDoing an update by adding this line.\n\n<!-- slug : " .. slug .. " -->" 
                     }
